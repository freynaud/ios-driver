...
/**
 * Created by freynaud on 23/09/2014.
 */
public class XcrunListParsingTest {

  private DeviceUUIDsMap parser = new DeviceUUIDsMap();
  ...
  public void parsesTypeOk(){
    Xcode601.DeviceType type = parser.getDeviceTypes().get(0);
  ...
  public void parsesRuntimeOk(){
    Xcode601.Runtime rt = parser.getRuntimes().get(1);
  ...
  public void parsesRuntimeOkWithLongVersion(){
    Xcode601.Runtime rt = parser.getRuntimes().get(0);
  ...
  public void parsesDevicesOk(){
    Xcode601.Device d = parser.getDevices().get(0);
    ...
    Assert.assertEquals(d.getKey(),"iPhone 4s (7.0.3 Simulator)");
  }

  @Test
  public void getDevice(){
    Xcode601.Runtime rt703 = parser.getRuntime("7.0.3");
    Xcode601.DeviceType type = parser.getDeviceType("iPhone 4s");
    Xcode601.Device d = parser.getDevice(rt703,type);
    Assert.assertEquals(d.getUuid(),"C1D891BF-A906-4E34-B467-C3F4138A91F1");
    Assert.assertEquals(d.getKey(),"iPhone 4s (7.0.3 Simulator)");
  }
  ...
  public void getDevice2(){
    Xcode601.Runtime rt8 = parser.getRuntime("8.0");
    Xcode601.DeviceType type = parser.getDeviceType("iPhone 6 Plus");
    Xcode601.Device d = parser.getDevice(rt8,type);
    Assert.assertEquals(d.getUuid(),"0817B996-B255-4662-B495-6E345A0FE7FF");
    Assert.assertEquals(d.getKey(),"iPhone 6 Plus (8.0 Simulator)");
  }
